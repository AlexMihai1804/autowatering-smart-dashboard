        ...
        <div className="flex items-center justify-between bg-mobile-surface-dark rounded-xl p-4 shadow-sm border border-mobile-border-dark">
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="text-right">
              ...
              <p className="text-sm font-bold text-white">4:00 AM</p>
            </div>
            ...
            {visibleZones.map((zone) => {
              ...
              return (
                <div
                  ...
                  className={`relative bg-mobile-surface-dark rounded-xl p-4 shadow-sm border-2 overflow-hidden cursor-pointer transition-all active:scale-[0.98] ${
                    isZoneWatering ? 'border-mobile-primary' : 'border-mobile-border-dark'
                  }`}
                >
